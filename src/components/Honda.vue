<template>
  <v-app>
    <nav class="container">
      <div class="link">
        <v-app-bar-title class="category">
          ...
          <!-- <a class="btn" href="/scooters"> Scooters </a>
                  <a class="btn" href=""> Sport </a> -->
        </v-app-bar-title>
    ...
    <v-container class="body">
      ...
      <v-row>
        <v-card class="mx-auto" max-width="400">
          <v-img height="300px" :src="adv" cover></v-img>
          <v-card-title>
            Perfect for Offroad
          </v-card-title>
          <v-card-subtitle>
    ...
    <v-fade-transition>
      <v-btn v-if="showButton" color="orange" icon class="back-to-top" @click="scrollToTop">
...
import adv from '../assets/Adv160.png';
